          ...
          <div className="mr-2 flex items-center gap-2">
            {setShowTotalReturn && (
              <AnimatedToggleGroup
                ...
                items={[
                  { value: "total", label: t("holdings.table.totalShort") },
                  { value: "daily", label: t("holdings.table.dailyShort") },
                ]}
                size="xs"
                rounded="md"
              />
            ...
            {hasMultipleCurrencies && (
              <Tooltip>
                ...
                <TooltipContent>
                  <p>
                    {showConvertedValues
                      ? t("holdings.table.showInAssetCurrency")
                      : t("holdings.table.showInBaseCurrency")}
                  </p>
                </TooltipContent>
              </Tooltip>
            )}
...
const getColumns = (
...
): ColumnDef<Holding>[] => [
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={t("holdings.table.position")} />
    ),
    meta: {
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        ...
        column={column}
        title={t("holdings.table.quantity")}
      />
    ),
    meta: {
      label: t("holdings.table.quantityFull"),
    },
    cell: ({ row }) => {
      ...
      return (
        <div className="flex min-h-[40px] flex-col items-end justify-center px-4">
          ...
          <span className="text-muted-foreground text-xs">
            {isOption
              ? t("holdings.table.contracts")
              : isBond
                ? t("holdings.table.bonds")
                : t("holdings.table.shares")}
          </span>
        </div>
      );
    },
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        className="justify-end text-right"
        column={column}
        title={t("holdings.table.todayPrice")}
      />
    ),
    meta: {
      label: t("holdings.table.todayPrice"),
    },
    cell: ({ row }) => {
      const holding = row.original;
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        ...
        column={column}
        title={t("holdings.table.bookCost")}
      />
    ),
    meta: {
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        className="justify-end"
        column={column}
        title={t("holdings.table.totalValue")}
      />
    ),
    meta: {
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        ...
        column={column}
        title={
          showTotalReturn ? t("holdings.table.unrealizedGain") : t("holdings.table.dayChange")
        }
      />
    ),
    meta: {
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={t("holdings.table.assetType")} />
    ),
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={t("holdings.table.currency")} />
    ),
    meta: {
            ...
            <DropdownMenuContent align="end">
              {hasInstrument && onClassify && (
                <DropdownMenuItem onClick={() => onClassify(holding)}>
                  ...
                  {t("holdings.table.actions.classify")}
                </DropdownMenuItem>
              )}
              <DropdownMenuItem onClick={handleNavigate}>
                <Icons.ChevronRight className="mr-2 h-4 w-4" />
                {t("holdings.table.actions.viewDetails")}
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
