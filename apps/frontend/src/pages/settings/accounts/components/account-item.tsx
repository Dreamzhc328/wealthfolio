            ...
            <TooltipProvider>
              <Tooltip delayDuration={300}>
                ...
                <TooltipContent side="bottom">
                  <p className="text-xs">
                    {account.trackingMode === "HOLDINGS"
                      ? t("accounts.tracking.holdingsHint")
                      : account.trackingMode === "NOT_SET"
                        ? t("accounts.tracking.needsSetupHint")
                        : t("accounts.tracking.transactionsHint")}
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
