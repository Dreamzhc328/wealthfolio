              ...
              <div className="space-y-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-base font-medium">
                        {t("contributionLimits.form.groupName")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          placeholder={t("contributionLimits.form.groupNamePlaceholder")}
                          {...field}
                          className="h-11 text-base"
                        />
                      </FormControl>
                      <FormDescription className="text-muted-foreground mt-1 text-sm">
                        {t("contributionLimits.form.groupNameHint")}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-base font-medium">
                        {t("contributionLimits.form.limitAmount")}
                      </FormLabel>
                      <FormControl>
                        <MoneyInput
                          placeholder={t("contributionLimits.form.limitAmountPlaceholder")}
                          {...field}
                        />
                      </FormControl>
                      <FormDescription className="text-muted-foreground mt-1 text-sm">
                        {t("contributionLimits.form.limitAmountHint")}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-base font-medium">
                            {t("contributionLimits.form.year")}
                          </FormLabel>
                          <FormControl>
                            <Input
                              type="number"
                              placeholder={t("contributionLimits.form.yearPlaceholder")}
                              value={field.value || ""}
                              onChange={(e) => {
                                const numValue =
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-base font-medium">
                            {t("contributionLimits.form.startDate")}
                          </FormLabel>
                          <div className="h-11">
                            <FormControl>
                              <DatePickerInput
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-base font-medium">
                            {t("contributionLimits.form.endDate")}
                          </FormLabel>
                          <div className="h-11">
                            <FormControl>
                              <DatePickerInput
                  ...
                  <p className="text-muted-foreground mt-2 text-sm italic">
                    {t("contributionLimits.form.datesHint")}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            >
              ...
              updateContributionLimitMutation.isPending ? (
                <>
                  ...
                  {defaultValues?.id
                    ? t("contributionLimits.form.updating")
                    : t("contributionLimits.form.saving")}
                </>
              ) : (
                <>
                  <Icons.Check className="mr-2 h-4 w-4" />
                  {defaultValues?.id
                    ? t("contributionLimits.form.update")
                    : t("contributionLimits.form.save")}
                </>
              )}
            </Button>
          </div>
