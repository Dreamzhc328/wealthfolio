  ...
  return (
    <>
      <div className="space-y-6">
        <SettingsHeader
          heading={t("contributionLimits.heading")}
        ...
        <div className="w-full pt-8">
          <h2 className="text-md text-muted-foreground mb-3 font-semibold">
            {t("contributionLimits.currentYear", { year: currentYear })}
          </h2>
          {currentYearLimits.length ? (
            ...
            <EmptyPlaceholder>
              ...
              <Button onClick={() => handleAddLimit()}>
                ...
                {t("contributionLimits.addALimit")}
              </Button>
            </EmptyPlaceholder>
          )}
          ...
          {previousYearsLimits.length > 0 && (
            <div className="mt-8">
              <div className="flex items-center justify-center">
                ...
                >
                  {showPreviousYears
                    ? t("contributionLimits.hidePrevious")
                    : t("contributionLimits.showPrevious")}
                </Button>
                <Separator className="flex-1" />
              </div>
