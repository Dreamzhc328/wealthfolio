...
export default function AddonSettingsPage() {
  ...
  const handleRatingSubmitted = () => {
    ...
    toast({
      title: t("addons.rating.thankYouTitle"),
      description: t("addons.rating.thankYouDescription"),
    });
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <SettingsHeader heading={t("addons.heading")} text={t("addons.description")} />
            ...
            <PopoverContent className="w-80">
              <div className="space-y-3">
                <div className="space-y-2">
                  <h4 className="font-medium">{t("addons.manager.headerInfoTitle")}</h4>
                  <p className="text-muted-foreground text-sm">
                    {t("addons.manager.headerInfoBody")}
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-muted-foreground text-xs">
                      <span className="font-medium text-amber-600">
                        {t("addons.manager.securityNoticeLabel")}
                      </span>{" "}
                      {t("addons.manager.securityNoticeBody")}
                    </p>
                  </div>
                </div>
              </div>
      ...
      >
        <TabsList className="grid w-full grid-cols-2">
          ...
          >
            ...
            <span className="truncate">{t("addons.manager.tabsInstalled")}</span>
          ...
          <TabsTrigger value="store" className="flex items-center justify-center gap-1.5 sm:gap-2">
            ...
            <span className="truncate">{t("addons.manager.tabsAvailable")}</span>
          </TabsTrigger>
        </TabsList>
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="text-muted-foreground flex flex-wrap items-center gap-x-3 gap-y-1 text-xs sm:text-sm">
                  ...
                  {hasUpdates() && (
                    <Badge
                      ...
                      className="text-xs"
                    >
                      {t("addons.manager.updatesAvailable", { count: getUpdateCount() })}
                      {getCriticalUpdateCount() > 0 &&
                        ` ${t("addons.manager.criticalSuffix", { count: getCriticalUpdateCount() })}`}
                    </Badge>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                  ...
                  <PopoverTrigger asChild>
                    <div>
                      <Button
                        ...
                        title={t("addons.manager.checkForUpdates")}
                      >
                        {isCheckingUpdates ? (
                  ...
                  <PopoverContent className="w-64" side="bottom" align="end">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Icons.Refresh className="h-4 w-4" />
                        <span className="font-medium">{t("addons.manager.checkForUpdates")}</span>
                      </div>
                      <p className="text-muted-foreground text-sm">
                        {t("addons.manager.checkForUpdatesBody")}
                      </p>
                      {hasUpdates() && (
                        <div className="border-t pt-2">
                          <Badge
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <div>
                      <Button
                        ...
                        title={t("addons.manager.installFromFile")}
                      >
                        {isLoading ? (
                          <Icons.Loader className="h-4 w-4 animate-spin" />
                        ) : (
                  ...
                  <PopoverContent className="w-64" side="bottom" align="end">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Icons.Plus className="h-4 w-4" />
                        <span className="font-medium">{t("addons.manager.installFromFile")}</span>
                      </div>
                      <p className="text-muted-foreground text-sm">
                        {t("addons.manager.installFromFileBody")}
                      </p>
                    </div>
                  </PopoverContent>
                </Popover>
                ...
                >
                  <Icons.Store className="h-4 w-4 flex-shrink-0" />
                  <span className="hidden sm:inline">{t("addons.manager.browseAddons")}</span>
                  <span className="sm:hidden">{t("addons.manager.browseShort")}</span>
                </Button>
              </div>
            </div>
            ...
            {isLoadingAddons ? (
              <div className="flex items-center justify-center py-12">
                ...
                <span className="text-muted-foreground ml-2 text-sm sm:text-base">
                  {t("addons.manager.loadingAddons")}
                </span>
              </div>
            ) : installedAddons.length === 0 ? (
              <EmptyPlaceholder>
                <EmptyPlaceholder.Icon name="Package" />
                <EmptyPlaceholder.Title>{t("addons.manager.emptyTitle")}</EmptyPlaceholder.Title>
                <EmptyPlaceholder.Description>
                  {t("addons.manager.emptyDescription")}
                </EmptyPlaceholder.Description>
                <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:gap-3">
                  <Button onClick={() => setActiveTab("store")} className="w-full sm:w-auto">
                    <Icons.Store className="mr-2 h-4 w-4" />
                    {t("addons.manager.browseAddons")}
                  </Button>
                  <Button
                    variant="outline"
                    onClick={handleLoadAddon}
                  ...
                  >
                    ...
                    {t("addons.manager.installFromFile")}
                  </Button>
                </div>
              </EmptyPlaceholder>
            ) : (
                        ...
                        {addon.metadata.author && (
                          ...
                          >
                            ...
                            <span className="truncate">
                              {t("addons.byAuthor", { author: addon.metadata.author })}
                            </span>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between gap-2 sm:ml-6 sm:justify-normal">
                        <div className="flex items-center gap-2">
                          ...
                          >
                            ...
                            <span className="sr-only">{t("addons.manager.viewPermissions")}</span>
                          </Button>
                          ...
                          >
                            ...
                            <span className="sr-only">{t("addons.manager.rateAddon")}</span>
                          </Button>

                          {/* Delete button with confirmation */}
                          <DeleteConfirm
                            deleteConfirmTitle={t("addons.manager.removeTitle")}
                            deleteConfirmMessage={
                              <div className="space-y-2">
                                <p>
                                  {t("addons.manager.removeConfirm")}{" "}
                                  <strong>{addon.metadata.name}</strong>?
                                </p>
                                <p className="text-muted-foreground text-sm">
                                  {t("addons.manager.removeWarning")}
                                </p>
                              </div>
                            }
                            ...
                            button={
                              ...
                              >
                                ...
                                <span className="sr-only">{t("addons.manager.removeTitle")}</span>
                              </Button>
                            }
                          />
      ...
      <PermissionDialog
        ...
        onDeny={() => {
          ...
          toast({
            title: t("addons.manager.installCancelledTitle"),
            description: t("addons.manager.installCancelledDescription"),
          });
        }}
      />
