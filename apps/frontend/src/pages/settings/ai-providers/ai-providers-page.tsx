  ...
  if (isLoading) {
    return (
      <div className="text-foreground space-y-6">
        <SettingsHeader heading={t("aiProviders.heading")} text={t("aiProviders.description")} />
        <Separator />
        ...
        <div className="border-destructive/20 bg-destructive/5 rounded-lg border p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-2">
              <h3 className="text-destructive font-medium">{t("aiProviders.loadFailed")}</h3>
      ...
      <div>
        {sortedProviders.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-lg font-semibold">{t("aiProviders.empty.title")}</h3>
