  ...
  return (
    <>
      <div className="space-y-6">
        <SettingsHeader heading={t("goals.heading")} text={t("goals.description")}>
          <>
            <Button
              size="icon"
              className="sm:hidden"
              onClick={() => handleAddGoal()}
              aria-label={t("goals.addGoalAria")}
            >
        ...
        <div className="w-full pt-8">
          {goals?.length ? (
            <>
              <h3 className="p-2 text-xl font-bold">{t("goals.sectionGoals")}</h3>
              ...
              <h3 className="p-2 pt-12 text-xl font-bold">{t("goals.sectionAllocations")}</h3>
              <h5 className="text-muted-foreground p-2 pb-4 pt-0 text-sm font-light">
                {t("goals.allocationsHint")}
              </h5>
              <GoalsAllocations
                goals={goals}
