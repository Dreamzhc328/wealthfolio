...
export function ImportQuotesSection({
  ...
  const STEPS = [
    { id: 1, title: t("marketData.quoteImport.steps.upload") },
    { id: 2, title: t("marketData.quoteImport.steps.preview") },
    { id: 3, title: t("marketData.quoteImport.steps.results") },
  ];
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-6 text-sm">
                      ...
                      {preview.duplicateCount > 0 && (
                        <div className="flex items-center gap-1.5">
                          <span className="text-muted-foreground">
                            {t("marketData.quoteImport.summary.duplicates")}
                          </span>
                    ...
                    <div className="flex items-center gap-2">
                      <Button variant="outline" onClick={handleStartOver}>
                        ...
                        {t("marketData.quoteImport.summary.back")}
                      </Button>
                      <Button
                        onClick={async () => {
                      ...
                      >
                        ...
                        {t("marketData.quoteImport.summary.importNQuotes", {
    ...
    <div className="space-y-6">
      {(showTitle || showHeaderButtons) && (
        ...
        >
          {showTitle && (
            <div>
              <h3 className="text-lg font-semibold">{t("marketData.import_.heading")}</h3>
              <p className="text-muted-foreground text-sm">
                {t("marketData.quoteImport.sectionDescription")}
              </p>
            </div>
          )}
          {showHeaderButtons && (
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" size="sm" onClick={handleStartOver}>
                ...
                {t("marketData.import_.startOver")}
              </Button>
            </div>
          )}
        </div>
