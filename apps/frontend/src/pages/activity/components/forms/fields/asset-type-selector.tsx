...
const assetTypes: AssetTypeOption[] = [
  { value: "stock", labelKey: "form.assetType.stock", icon: "TrendingUp" },
  { value: "option", labelKey: "form.assetType.option", icon: "BarChart" },
  { value: "bond", labelKey: "form.assetType.bond", icon: "FileText" },
];
