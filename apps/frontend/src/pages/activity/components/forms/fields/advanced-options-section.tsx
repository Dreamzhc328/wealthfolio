  ...
  return (
    ...
    >
      <CollapsibleTrigger asChild>
        ...
        >
          <span className="text-sm font-medium">{t("form.fields.advancedOptions")}</span>
          <Icons.ChevronDown
        ...
        >
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <CurrencyInput
                      ...
                      placeholder={t("form.fields.selectCurrency")}
                      className="w-full"
          ...
          {showFxRate && fxRateName && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("form.fields.fxRate")}</FormLabel>
                  <FormControl>
                    <MoneyInput
                      ref={field.ref}
                      name={field.name}
          ...
          {showSubtype && subtypeName && availableSubtypes.length > 0 && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("form.fields.subtype")}</FormLabel>
                  <FormControl>
                    <Select
                      onValueChange={(value) => field.onChange(value === "__none__" ? null : value)}
                      value={field.value ?? "__none__"}
                    >
                      <SelectTrigger aria-label={t("form.fields.subtype")} data-testid="subtype-select">
                        <SelectValue placeholder={t("form.fields.selectSubtype")} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="__none__">
                          <span className="text-muted-foreground">{t("form.fields.none")}</span>
                        </SelectItem>
