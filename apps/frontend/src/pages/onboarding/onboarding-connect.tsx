...
const featureDefs = [
  {
    ...
    titleKey: "connect.features.brokerageSync.title",
    descriptionKey: "connect.features.brokerageSync.description",
    color: "orange",
  },
  {
    icon: Icons.Devices,
    titleKey: "connect.features.deviceSync.title",
    descriptionKey: "connect.features.deviceSync.description",
    color: "green",
  },
  {
    icon: Icons.UserSwitch,
    titleKey: "connect.features.householdView.title",
    descriptionKey: "connect.features.householdView.description",
    color: "blue",
  },
];
  ...
  return (
    <div className="w-full max-w-3xl space-y-6">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="mb-2 text-xl font-semibold">{t("connect.title")}</h2>
      ...
      <div className="grid gap-3 sm:grid-cols-3 sm:gap-4">
        {featureDefs.map((feature) => {
          ...
          return (
            <Card key={feature.titleKey} className="border p-3 sm:p-5">
