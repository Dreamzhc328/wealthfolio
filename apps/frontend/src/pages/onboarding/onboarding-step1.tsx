  ...
  return (
    <div className="w-full max-w-5xl space-y-4 md:space-y-6">
      <div className="text-center">
        <p className="text-muted-foreground">{t("step1.tagline")}</p>
      </div>
      ...
      <div className="mx-auto grid gap-5 px-2 md:grid-cols-2 md:gap-6 md:px-4 lg:gap-8">
        <Card className="border-border/50 from-card to-card/80 hover:border-primary/50 bg-linear-to-br group relative flex flex-col overflow-hidden border-2 p-5 transition-all duration-300 hover:shadow-lg md:p-6">
          ...
          <div className="relative mb-3 flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold md:text-xl">{t("step1.holdings.title")}</h3>
              <p className="text-muted-foreground text-sm">{t("step1.holdings.subtitle")}</p>
            </div>
          </div>
          ...
          <div className="relative mb-6 flex-1 space-y-2 md:space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <p className="text-sm">{t("step1.holdings.features.netWorth")}</p>
            </div>
            <div className="flex items-center gap-2.5">
              <Icons.Check className="h-4 w-4 text-green-600 dark:text-green-400" />
              <p className="text-sm">{t("step1.holdings.features.valueAndPnl")}</p>
            </div>
            <div className="flex items-center gap-2.5">
              <Icons.Check className="h-4 w-4 text-green-600 dark:text-green-400" />
              <p className="text-sm">{t("step1.holdings.features.pricePerformance")}</p>
            </div>
            <div className="flex items-center gap-2.5">
              <Icons.Check className="h-4 w-4 text-green-600 dark:text-green-400" />
              <p className="text-sm">{t("step1.holdings.features.fastSetup")}</p>
            </div>
          </div>

          {/* Limit & Note - softened */}
          <div className="text-muted-foreground/70 relative mt-auto space-y-2 text-xs">
            <p>{t("step1.holdings.limit")}</p>
            <p>{t("step1.holdings.note")}</p>
          </div>
        </Card>
        ...
        <Card className="border-border/50 from-card to-card/80 hover:border-primary/50 bg-linear-to-br group relative flex flex-col overflow-hidden border-2 p-5 transition-all duration-300 hover:shadow-lg md:p-6">
          ...
          <div className="relative mb-3 flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold md:text-xl">{t("step1.transactions.title")}</h3>
              <p className="text-muted-foreground text-sm">{t("step1.transactions.subtitle")}</p>
            </div>
          </div>
          ...
          <div className="relative mb-6 flex-1 space-y-2 md:space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <p className="text-sm">{t("step1.transactions.features.totalReturn")}</p>
            </div>
            <div className="flex items-center gap-2.5">
              <Icons.Check className="h-4 w-4 text-blue-600 dark:text-blue-400" />
              <p className="text-sm">{t("step1.transactions.features.gainsAndCashflow")}</p>
            </div>
            <div className="flex items-center gap-2.5">
              <Icons.Check className="h-4 w-4 text-blue-600 dark:text-blue-400" />
              <p className="text-sm">{t("step1.transactions.features.completeView")}</p>
            </div>
            <div className="flex items-center gap-2.5">
              <Icons.Check className="h-4 w-4 text-blue-600 dark:text-blue-400" />
              <p className="text-sm">{t("step1.transactions.features.bestWithBroker")}</p>
            </div>
          </div>

          {/* Limit & Note - softened */}
          <div className="text-muted-foreground/70 relative mt-auto space-y-2 text-xs">
            <p>{t("step1.transactions.limit")}</p>
            <p>{t("step1.transactions.note")}</p>
          </div>
        </Card>
      </div>
