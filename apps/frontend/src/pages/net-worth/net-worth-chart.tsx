    ...
    <div className="bg-popover grid grid-cols-1 gap-1.5 rounded-md border p-2 shadow-md">
      ...
      <div className="flex items-center justify-between space-x-4">
        <div className="flex items-center space-x-1.5">
          ...
          <span className="text-muted-foreground text-xs">{t("netWorth.chart.netWorthLabel")}</span>
        </div>
        <AmountDisplay
      ...
      {hasLiabilities && (
        <div className="border-border mt-1 border-t pt-1.5">
          ...
          <div className="flex items-center justify-between space-x-4">
            <span className="text-muted-foreground/70 text-xs">
              {t("netWorth.chart.liabilitiesLabel")}
            </span>
...
export function NetWorthChart({ data, isLoading }: NetWorthChartProps) {
  ...
  const chartConfig = {
    netWorth: {
      label: t("netWorth.chart.netWorth"),
    },
