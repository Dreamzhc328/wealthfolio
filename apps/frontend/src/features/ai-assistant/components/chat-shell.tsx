    ...
    <Sheet>
      ...
      >
        <SheetHeader className="sr-only">
          <SheetTitle>{t("threadSidebar.header")}</SheetTitle>
        </SheetHeader>
        <div className="flex h-14 items-center border-b px-4">
          <span className="font-semibold">{t("threadSidebar.header")}</span>
        </div>
  ...
  return (
    <header className="pt-safe flex shrink-0 items-center gap-2 border-b px-4">
      ...
      <ButtonWithTooltip
        variant="ghost"
        size="icon"
        tooltip={sidebarCollapsed ? t("header.showSidebar") : t("header.hideSidebar")}
        side="bottom"
      ...
      <Tooltip>
        ...
        <TooltipContent side="bottom">{t("common.betaTooltip")}</TooltipContent>
      </Tooltip>
    </header>
  );
}
